...
namespace Quests
{
	...
	public class CompQuestGiver : ThingComp
	{
		...
		public override IEnumerable<FloatMenuOption> CompFloatMenuOptions(Pawn selPawn)
		{
			...
			{
				Job job = new Job(QuestsDefOf.TakeQuest);
			...
			FloatMenuOption dialog = new FloatMenuOption(Translator.Translate("Dialog"), delegate ()
			{
				var startDialog = DefDatabase<DialogDef>.GetNamed("TestDialog");
				var diaNode = new DiaNode(startDialog.text);
				var window = new DialogWindow(diaNode);
				window.curDialog = startDialog;
				window.initiator = selPawn;
				window.talker = this.parent as Pawn;
				window.StartDialog();
